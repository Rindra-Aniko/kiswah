      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-12 gap-8 md:gap-4 lg:gap-12 pb-12">
        ...
        <div className="md:col-span-5 flex flex-col space-y-4">
          <div className="flex items-center space-x-3">
            {/* Menggunakan Image Next.js untuk file logo.webp lokal */}
        ...
        <div className="md:col-span-4 flex flex-col space-y-4 text-sm lg:text-sm">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-2 text-xs">
            ...
            >
              <div className="bg-[#00E676] text-white p-1.5 rounded-md flex items-center justify-center">
            ...
            <a 
              ...
              className="flex items-center space-x-2 group"
            >
              <div className="bg-[#1877F2] text-white p-1.5 rounded-full flex items-center justify-center">
                <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
            ...
            <a 
              ...
              className="flex items-center space-x-2 group"
            >
              <div className="bg-gradient-to-tr from-[#FFB200] via-[#FF007A] to-[#7B00FF] text-white p-1.5 rounded-md flex items-center justify-center">
                <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
