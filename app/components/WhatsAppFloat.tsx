...
const WhatsAppFloat = () => {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-[9999] flex flex-col items-end gap-3 pointer-events-none">
      ...
      >
        <svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" className="w-8 h-8" viewBox="0 0 512 512" fill="currentColor">
        ...
        <span className="sr-only">Hubungi kami melalui WhatsApp</span>
        
        {/* Glow Effect */}
        <span className="absolute inset-0 rounded-full bg-[#25D366] opacity-40 group-hover:animate-ping -z-10" aria-hidden="true"></span>
      </a>
    </div>
  );
};
