...
// 1. Definisi Interface untuk Type-Safety Data Tim
...
// 2. Data Tim Profesional (Direksi)
const professionalTeam: TeamMember[] = [
  { id: 1, name: 'DR. HADIAL PUTRA, M.Ag', role: 'Komisaris', imageSrc: '/team/hadial.webp' },
  { id: 2, name: 'IDMANITA JULIANA, SH, MH', role: 'Direktur Utama', imageSrc: '/team/it.webp' },
  { id: 3, name: 'EDWIS TOMI RAHMAN, S.Pd.I', role: 'Direktur Operasional', imageSrc: '/team/buya_duis.webp' },
];

// 3. Data Staf Management
...
export default function TentangKamiPage() {
  return (
    <div>
      ...
      {/* 3. Our Team Section: Tim Profesional & Management */}
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center space-y-3 mb-12 md:mb-16">
            ...
            <p className="font-poppins font-normal text-sm sm:text-base text-[#291F15]/80 max-w-md mx-auto pt-1">
              Silahkan hubungi kami atau kunjungi kantor pelayanan kami untuk konsultasi perjalanan ibadah Anda.
            </p>
          </div>
              ...
              <div className="space-y-6 md:space-y-8">
                <div className="flex items-start gap-4 group">
                  ...
                  <div className="space-y-1 font-poppins text-[#291F15]">
                    <h4 className="font-bold text-base">Alamat Kantor</h4>
                    <p className="text-sm text-[#291F15]/80 leading-relaxed">
                      Desa Air Bersih, Dusun Baru Semurup, <br />
                      Kec. Air Hangat Barat, Kabupaten Kerinci, <br />
                      Jambi 37166
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4 group">
                  ...
                  <div className="space-y-1 font-poppins text-[#291F15]">
                    <h4 className="font-bold text-base">Email Resmi</h4>
                ...
                <div className="flex items-start gap-4 group">
                  ...
                  <div className="space-y-1 font-poppins text-[#291F15]">
                    <h4 className="font-bold text-base">Jam Operasional</h4>
                    <p className="text-sm text-[#291F15]/80">
